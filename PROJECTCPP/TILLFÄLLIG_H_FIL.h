#pragma once
//HÄR SKRIVER JAG IN VILKA KRAV VI HAR UPPNÅTT


//Smarta pekare implementerat = 1p
//Användande av undantagshantering där detta är lämpligt = 1p
//Grafiskt användargränssnitt(ex - vis SFML) = förhoppnigsvis mer än 2p
